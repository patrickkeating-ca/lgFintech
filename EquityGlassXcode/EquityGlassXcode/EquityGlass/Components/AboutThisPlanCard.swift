    ...
    AboutThisPlanCard(
        recommendation: AdvisorRecommendation(
            ...
            discussionPoints: [
                ...
                "Q1 charitable giving alignment with vesting schedule",
                "70/30 split execution timing"
            ],
            recommendationText: "Execute the 70/30 split on vest date. Move 70% to your diversified portfolio immediately. Sell 30% and transfer to checking for tax withholding and charitable contributions.",
            holdPercentage: 0.70,
            sellPercentage: 0.30
        ),
